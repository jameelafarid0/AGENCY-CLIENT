                        ...
                        <div className="bg-white p-5 container-fluid row submit-area">
                            <div className="col-md-6">
                                ...
                                <div className="form-group">
                                    <label
                                        htmlFor=""><strong><h5>Description</h5></strong></label>
                                    <textarea onBlur={handleBlur}
                                        type="text" ref={register({ required: true })} name="description"
                                        className="form-control" cols="30" rows="6" placeholder="Enter Description"></textarea>
                            ...
                            <div class="col-md-4">
                                <label
                                    htmlFor=""><strong><h5>Icon</h5></strong></label>
                                <input onChange={handleFileChange}
                                    type="file" className="btn btn-success form-control-lg" />
                            </div>
                        </div>
